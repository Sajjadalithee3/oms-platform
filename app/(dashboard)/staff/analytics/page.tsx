...
export default function StaffAnalyticsPage() {
  ...
  return (
    <>
      <TopBar title="Staff Analytics" />
      <div className="p-6 space-y-6">
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
          <StatCard title="Job Seekers" value={data.jobSeekers} icon={<Users className="h-6 w-6" />} />
          <StatCard title="Learners" value={data.learners} icon={<Users className="h-6 w-6" />} />
          <StatCard title="Active Jobs" value={data.activeJobs} icon={<Briefcase className="h-6 w-6" />} />
